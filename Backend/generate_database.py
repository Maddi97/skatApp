...
def create_database():
    ...
    'game', meta, 
        ...
        Column('player1', Integer, ForeignKey("player.playerID"), nullable=False), 
        Column('player2', Integer, ForeignKey("player.playerID"), nullable=False), 
        Column('player3', Integer, ForeignKey("player.playerID"), nullable=False), 
        Column('player4', Integer, ForeignKey("player.playerID"), nullable=True), 
        Column('player5', Integer, ForeignKey("player.playerID"), nullable=True), 
    )
